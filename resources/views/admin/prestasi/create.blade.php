...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Tambah Prestasi Baru</h2>
</div>
        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="title_line1" value="{{ old('title_line1') }}" required autofocus
                ...
                <div>
                    ...
                    <input type="text" name="title_line2" value="{{ old('title_line2') }}" required
                        class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] transition-all
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" placeholder="Juara 1 Olimpiade Matematika Nasional" required
                    class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] transition-all
            ...
            <div>
                ...
                <textarea name="description" rows="4" required
                    class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] transition-all
                          @error('description') border-red-500 bg-red-50 @enderror">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" name="category" value="{{ old('category') }}" placeholder="Akademik" required
                        class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] transition-all
                ...
                <div>
                    ...
                    <input type="text" name="date" value="{{ old('date') }}" placeholder="2024" required
                        class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#ff6b35]/50 focus:border-[#ff6b35] transition-all
            ...
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-2">Gambar Prestasi (Upload File) <span class="text-gray-400 font-normal ml-1">(Pilih salah satu dengan URL)</span></label>
                    <div class="relative">
